/obj/item/gun/ballistic/automatic/rpl
	name = "RPL-SMG"
	desc = "The RPL is ideal for close quarters and easy to use; it combines a high fire rate, large magazine, quick reload and good mobility."
